...
import logo from '/public/img/logo para navbar.png';
  ...
  return (
    <div className="hero-wrapper">
      ...
      <div className="social-icons">
        <a href="https://www.instagram.com/droningmapping" target="_blank" rel="noopener noreferrer" className="social-link">
        ...
        <a href="https://www.facebook.com/profile.php?id=61554254472595" target="_blank" rel="noopener noreferrer" className="social-link">
          <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
      ...
      <style>{`
        ...
        .background-image {
          ...
          width: 100%;
          height: 100%;
          background: url('/img/foto de portada.jpg') no-repeat center center;
